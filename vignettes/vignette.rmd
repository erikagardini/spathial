...
* __1__ _(default)_: the user can choose the start and end points directly from the 2D representations of the data points. 
...
```
In order to visualize the multidimensional dataset in two dimensions, one performs a t-SNE analysis on it [2].
