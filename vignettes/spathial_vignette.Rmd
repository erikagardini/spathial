...
![prefiltering example](figures/2D_constellation/datapoints.png)
...
![prefiltering example](figures/2D_constellation/boundaries.png)
...
![prefiltering example](figures/2D_constellation/prefiltering.png)
...
![prefiltering example](figures/2D_constellation/pp_no_prefiltering.png)
![prefiltering example](figures/2D_constellation/pp_prefiltering.png)
...
![prefiltering example](figures/2D_constellation/labels.png)

![prefiltering example](figures/2D_constellation/labels_no_prefiltering.png)
...
![prefiltering example](figures/2D_constellation/correlations_no_prefiltering.png)
![prefiltering example](figures/2D_constellation/correlations_prefiltering.png)
...
![prefiltering example](figures/liver_tcga/labels.png)
![prefiltering example](figures/liver_tcga/pp_plot.png)
...
![prefiltering example](figures/liver_tcga/correlation.png)
...
When you want to work with high dimensional data, one of the problem that could occur is the overfitting. This means that the principal path algorithm could find a lot of different features all correlated with the evolution from the starting point to the ending one. 

If you are interested in finding a restricted group of features which are very correlated with the evolution, we suggest to use a more complex version of the function ```spathialWay```. It takes as input the parameter ```neighbour > 1``` and perform a refined version of the principal path algorithm.

The following picture graphically explain how this version of the function ```spathialWay``` works when ```neighbour > 1```:
