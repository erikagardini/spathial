...
boundary_init <- spathial_boundary_ids(X, X_labels, mode=1, from=5, to=48)
...
ppath_labels <- spathial_labels(X, X_labels, ppath)
spathial_2D_plot(X, X_labels, boundary_ids, ppath)
corr_values <- spathial_corr(ppath)
message(corr_values)
